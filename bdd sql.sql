...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 09 déc. 2019 à 16:55
...
CREATE TABLE IF NOT EXISTS `favoris` (
  ...
  KEY `favoris_candidats0_FK` (`idCandidat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `favoris`
  ADD CONSTRAINT `favoris_annonces_FK` FOREIGN KEY (`id`) REFERENCES `annonces` (`id`),
  ADD CONSTRAINT `favoris_candidats0_FK` FOREIGN KEY (`idCandidat`) REFERENCES `candidats` (`id`);
